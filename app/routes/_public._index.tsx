      ...
      <section className="text-center mb-24">
        <div className="mb-8">
          ...
          <p className="text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Crafting thoughtful digital experiences with clean code and user-centric design
          </p>
        </div>
        ...
        <div className="flex justify-center space-x-4">
          ...
          >
            <Link to="/app/routes/__public/about">About Me</Link>
          </Button>
        </div>
      </section>
      ...
      <section className="mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="group border-0 shadow-sm hover:shadow-md transition-all duration-300 bg-white dark:bg-slate-900 dark:border dark:border-slate-800">
            <div className="aspect-video bg-gradient-to-br from-soft-blue-50 to-soft-blue-100 dark:from-soft-blue-900/20 dark:to-soft-blue-900/40 rounded-t-lg overflow-hidden">
            ...
            <CardContent className="p-6">
              ...
              <p className="text-slate-600 dark:text-slate-300 text-sm mb-4 leading-relaxed">
                A modern web application streamlining government services for citizens
              </p>
              <div className="flex items-center justify-between">
                <div className="flex space-x-3">
                  <span className="text-xs text-slate-500 dark:text-slate-400 bg-soft-blue-50 dark:bg-soft-blue-900/30 px-2 py-1 rounded">
                    React
                  </span>
                  <span className="text-xs text-slate-500 dark:text-slate-400 bg-soft-blue-50 dark:bg-soft-blue-900/30 px-2 py-1 rounded">
                    Next.js
          ...
          <Card className="group border-0 shadow-sm hover:shadow-md transition-all duration-300 bg-white dark:bg-slate-900 dark:border dark:border-slate-800">
            ...
            <CardContent className="p-6">
              ...
              <p className="text-slate-600 dark:text-slate-300 text-sm mb-4 leading-relaxed">
                Collaborative workspace for teams with real-time updates and intuitive design
              </p>
              <div className="flex items-center justify-between">
                <div className="flex space-x-3">
                  <span className="text-xs text-slate-500 dark:text-slate-400 bg-soft-blue-50 dark:bg-soft-blue-900/30 px-2 py-1 rounded">
